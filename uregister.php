...
<form name="frm" method="get" action="usubmit.php" onsubmit="return validation();">
	...
	<td><h4><input type="text" id="first_name" name="first_name" placeholder="Enter First Name"></h4></td>
	</tr>
	<tr>
	<td><h3>Last Name</h3></td>
	<td><h4><input type="text" id="last_name" name="last_name" placeholder="Enter Last Name"></h4></td>
	
	</tr>
	<tr>
	<td><h3>Password</h3></td>
	<td><h4><input type="password" id="password" name="password" placeholder="Enter Password"></h4></td>
	
	</tr>
	<tr>
	<td><h3>Confirm Password</h3></td>
	<td><h4><input type="password" id="cpassword" name="cpassword"  placeholder="Re-enter your Password"></h4></td>
	
	</tr>
	<tr>
	<td><h3>DOB</h3></td>
	<td><h4><input type="date" id="dob" name="dob" placeholder="Enter Date Of Birth"></h4></td>
	
	</tr>
	<tr>
	<td><h3>Gender</h3></td>
	<td><h4><input type="radio" id="sex" name="gender" value="male">Male</h4>
	<h4><input type="radio" id="sex" name="gender" value="female">Female</h4>
    </td>
	</tr>
	<tr>
	<td><h3>Street</h3></td>
	<td><h4><input type="text" id="street" name="street" placeholder="Enter Street"></td>
	
	</tr>
	<tr>
	<td><h3>Location</h3></td>
	<td><h4><input type="text" id="location" name="location" placeholder="Enter Your Location"></h4></td>
	
	</tr>
	<tr>
	<td><h3>City</h3></td>
	<td><h4><input type="text" id="city" name="city"  placeholder="Enter Your City"></h4></td>
	
	</tr>
	<tr>
	<td><h3>State</h3></td>
	<td><h4><input type="text" id="state" name="state" placeholder="Enter Your State"></h4></td>
	
	</tr>
	<tr>
	<td><h3>Pincode</h3></td>
	<td><h4><input type="text" id="pincode" name="pincode"  placeholder="Enter Your Pincode"></h4></td>
    ...
    <td colspan="2" align="center"><h3><input type="submit" name="submit" value="register"></h3></td>
    </tr>
	</table>
	</form>
