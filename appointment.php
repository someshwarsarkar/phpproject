...
<form method="post" name="frm">
	...
	<tr>
	<td align="center"><h1>Appointment</h1></td>
	</tr>
	<tr>
	<td><input type="name" name="name" required placeholder="Enter Name"></td>
	</tr>
	<tr>
	...
	<tr>
	<td>&nbsp;</td>
	<td><h3><input type="submit" name="appointment" value="Take Appointment"></h3></td>
	</tr>
	<tr>
