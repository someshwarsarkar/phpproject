...
function check_email(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","checkdemail.php?email_id="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<?php
$doctor_id=$_SESSION['info']['doctor_id'];
$src="SELECT * FROM doctor WHERE doctor_id=$doctor_id";
$rs=mysqli_query($con,$src);
$rec=mysqli_fetch_assoc($rs);
?>
<form name="frm" method="post" action="editdsubmit.php" onSubmit="return validation();">
	...
	<td><h4><input type="name" name="first_name" value="<?php echo $rec['first_name']; ?>" id="first_name"></h4></td>
	</tr>
	<tr>
	<td><h4>Last Name</h4></td>
	<td><h4><input type="name" name="last_name"   value="<?php echo $rec['last_name']; ?>" id="last_name"></h4></td>
	</tr>
	<tr>
	<td><h4>Password</h4></td>
	<td><h4><input type="password" name="password"  id="password" ></h4></td>
	</tr>
	<tr>
	<tr>
	<td><h4>Confirm Password</h4></td>
	<td><h4><input type="password" name="cpassword"  id="cpassword"></h4></td>
	</tr>
	<tr>
	<td><h4>Photo</h4></td>
	...
	<tr>
	<td><h4>DOB</h4></td>
	<td><h4><input type="date" name="dob" id="dob"  value="<?php echo $rec['dob']; ?>"></td>
	</tr>
	<tr>
	<td><h4>DOJ</h4></td>
	<td><h4><input type="date" name="doj" id="doj" value="<?php echo $rec['doj']; ?>"></h4></td>
	</tr>
	<tr>
	<td><h4>Gender</h4></td>
	<td><h4><input type="radio" name="gender" id="sex" value="male"  <?php 
if($rec["gender"]=='male'){
echo "checked";
}
?>>Male</h4>
		<h4><input type="radio" name="gender" id="sex" value="female"  <?php 
...
?>>Female</h4>
	...
	<td><h4><input type="text" name="qualification" id="qualification" value="<?php echo $rec['qualification']; ?>" ></h4></td>
	</tr>
	<tr>
	<tr>
	<td><h4>specialization</h4></td>
	<td><h4><input type="text" name="specialization"  id="specialization" value="<?php echo $rec['specialization']; ?>"></h4></td>
	</tr>
	<tr>
	<td><h4>YOE</h4></td>
	<td><input type="yoe" name="yoe" id="yoe" value="<?php echo $rec['yoe']; ?>"></td>
	</tr>
	<tr>
	<td><h4>Street</h4></td>
	<td><h4><input type="text" name="street" id="street" value="<?php echo $rec['street']; ?>"></h4></td>
	</tr>
	<tr>
	<td><h4>Location</h4></td>
	<td><h4><input type="text" name="location" id="location" value="<?php echo $rec['location']; ?>"></h4></td>
	</tr>
	<tr>
	<td><h4>City</h4></td>
	<td><h4><input type="text" name="city" id="city" value="<?php echo $rec['city']; ?>"></h4></td>
	</tr>
	<tr>
	<td><h4>State</h4></td>
	<td><h4><input type="text" name="state" id="state" value="<?php echo $rec['state']; ?>"></h4></td>
	</tr>
	<tr>
	<td><h4>Pincode</h4></td>
	<td><h4><input type="text" name="pincode" id="pincode" value="<?php echo $rec['pincode']; ?>"></h4></td>
	</tr>
	<tr>
	<td><h4>Contact No.</h4></td>
	<td><h4><input type="text" name="contact_no" id="mobile" value="<?php echo $rec['contact_no']; ?>"></h4></td>
	</tr>
	<tr>
	...
	<tr>
	<td><a href="dprofile.php">Go<br>Back</a></td>
