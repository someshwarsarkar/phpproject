...
if(isset($_REQUEST['msg'])){
	echo '<h4 style="color:green">'.$_REQUEST['msg'].'</h4>';
	
}?>
<form method="post" name="frm" action="ulogincode.php">
	<table cellpadding="5"  align="center">
	<tr>
	<td align="center"><h1>User Log In</h1></td>
	</tr>
	<tr>
	<td><h2>Email</h2></td>
	...
	<td><h3><input type="password" name="password" required placeholder="Enter password"></h3></td>
	</tr>
	<tr>
	<td>&nbsp;</td>
	...
	<tr>
	<td colspan="2" align="center"><h3>If you have not register yet <a href="uregister.php">Click here</a></h3></td>
	</tr>
	<tr>
	<td colspan="2" align="center"><h3><a href="uregister.php">Forgot password</a></h3></td>
	</tr>
	</table>
	</form>
