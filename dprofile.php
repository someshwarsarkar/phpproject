...
if(isset($_REQUEST['msg'])){
	echo '<h4 style="color:red;">'.$_REQUEST['msg'].'</h4>';
	
}?>
<table>
<thead>
<tr>
<th><h2>Hi <?php echo $_SESSION['info']['first_name'];?> <?php echo $_SESSION['info']['last_name'];?></h2></th>
<?php
for($i=1;$i<=100;$i++){
echo '<th>&nbsp;</th>';
}
?>
<th><a href="editdprofile.php?doctor_id=<?php echo $_SESSION['info']['doctor_id']; ?>">^Edit Profile</a></th>
<th><a href="sechedule.php?doctor_id=<?php echo $_SESSION['info']['doctor_id']; ?>">^Enter Sechedule</a></th>
<th>&nbsp;</th>
<th>&nbsp;</th>
<th><a href="patientdetails.php">^Enter Patient Details</a></th>
<th><a href="leave.php?doctor_id=<?php echo $_SESSION['info']['doctor_id']; ?>">^Take Leave</a></th>
</thead>
<tbody>
<?php
for($i=1;$i<=2;$i++){
...
?>
<tr>
<td><img src="<?php echo $_SESSION['info']['photo'];?>" width="150" height="200"></td>
</tr>
<tr>
<td><a href="dlogout.php"><button>Logout</button></a></td>
</tr>
</tbody>
</table>
